This starter application helps you develop a secure Liberty application to avoid introducing common security vulnerabilities such as Cross-Site Scripting (XSS), Injection, Directory Traversal, <span class="gray"> and Session Hijacking</span>.</p>
			 
The secure GoodServlet.java in the package employs a number of good coding practices such as input validation, output encoding, secure Http Header settings, Content Security Policy, <span class="gray">session management, and safe SQL statement</span>. Using it as a development starting point, your application will inherit the necessary defense against many common security vulnerabilities.
